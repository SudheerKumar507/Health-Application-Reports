...
//   .controller('ViewerCtrl', ['$rootScope', '$scope', '$http', 'Sample', function ($rootScope, $scope, $http, Sample) {
//     var baseURL = 'http://13.126.239.21:3042';


//     var getStates = function () {
//       Sample.getStates().then(function (data) {
//         $scope.states = data;
//       })
//     }();
...
//       Sample.getDistrictsData(data).then(function (districtData) {
